...
Run this script from the directory containing the ghost, gitian-builder, gitian.sigs, and bitcoin-detached-sigs.
...
-u|--url        Specify the URL of the repository. Default is https://github.com/ghost-core/ghost-core
...
then
    ...
    git clone https://github.com/ghost-coin/gitian.sigs
    git clone https://github.com/ghost-coin/ghost-detached-sigs
