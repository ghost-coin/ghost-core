...
if [ "$RUN_FUZZ_TESTS" = "true" ]; then
  ...
  if [ ! -d "$DIR_UNIT_TEST_DATA" ]; then
    ...
    DOCKER_EXEC curl --location --fail https://github.com/tecnovert/particl-qa-assets/raw/main/unit_test_data/script_assets_test.json -o "${DIR_UNIT_TEST_DATA}/script_assets_test.json"
  fi
fi
