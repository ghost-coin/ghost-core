...
export DEP_OPTS="NO_WALLET=1 NO_USB=1 CC_FOR_BUILD=clang-7 CC=clang-7 CXX='clang++-7 -stdlib=libc++'"
export GOAL="install"
export BITCOIN_CONFIG="--enable-reduce-exports CC_FOR_BUILD=clang-7 CC=clang-7 CXX='clang++-7 -stdlib=libc++'"
