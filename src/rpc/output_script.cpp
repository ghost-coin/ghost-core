    ...
    return RPCHelpMan{
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::STR, "address", /* optional */ true, "The ghost address validated"},
                ...
                {RPCResult::Type::STR, "stakeonly_address", /* optional */ true, "The ghost address encoded as a stakeonly_address"},
