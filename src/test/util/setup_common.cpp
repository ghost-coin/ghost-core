      ...
      m_args{}
{
    ...
    fBalancesIndex = m_node.args->GetBoolArg("-balancesindex", ghost::DEFAULT_BALANCESINDEX);
...
void ChainTestingSetup::LoadVerifyActivateChainstate()
{
    ...
    csl_args.address_index = m_node.args->GetBoolArg("-addressindex", ghost::DEFAULT_ADDRESSINDEX);
    csl_args.spent_index = m_node.args->GetBoolArg("-spentindex", ghost::DEFAULT_SPENTINDEX);
    csl_args.timestamp_index = m_node.args->GetBoolArg("-timestampindex", ghost::DEFAULT_TIMESTAMPINDEX);
    csl_args.balances_index = m_node.args->GetBoolArg("-balancesindex", ghost::DEFAULT_BALANCESINDEX);
